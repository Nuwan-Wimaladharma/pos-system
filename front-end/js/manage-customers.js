...
btnSave.on('click', () => {
    ...
    xhr.open('POST', 'http://localhost:8080/pos/api/v1/customers', true);
...
function getCustomers(){
    ...
    xhr.open('GET', 'http://localhost:8080/pos/api/v1/customers' + query, true);
...
tbodyElm.on('click', ".delete", (eventData)=> {
    ...
    const xhr = new XMLHttpRequest();
    const jqxhr = $.ajax(`http://localhost:8080/pos/api/v1/customers/${id}`, {
        method: 'DELETE',
